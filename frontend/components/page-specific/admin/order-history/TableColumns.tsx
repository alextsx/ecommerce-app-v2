...
import { AdminOrderDetailsSheet } from './sheet/DetailsSheet';

export const AdminOrderHistoryTableColumns: ColumnDef<DetailedAdminOrderType>[] = [
  {
    ...
    cell: ({ row }) => (
      <div className="p-3 text-center">
        <AdminOrderDetailsSheet
          orderItems={row.original.orderItems}
